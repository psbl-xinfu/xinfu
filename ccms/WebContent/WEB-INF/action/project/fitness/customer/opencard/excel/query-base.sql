...
and (case when ${fld:daochu_opentype} is null then 1=1 else 
		(case when ${fld:daochu_opentype}='1' then 1=1 else 1=2 end) end)
...
and (case when ${fld:daochu_opentype} is null then 1=1 else 
		(case when ${fld:daochu_opentype}='1' then 1=2 else 1=1 end) end)
${filter}
