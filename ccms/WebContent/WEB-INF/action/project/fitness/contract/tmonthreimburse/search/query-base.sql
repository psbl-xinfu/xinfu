SELECT
	concat('<input type="checkbox"  data-am-ucheck name="datalist" code="',con.status,'" value="',con.code,'',
 		'" code-cust="',con.customercode,'" code-relate="',COALESCE(con.relatecode,''),'" code-cttype="',con.contracttype,'" code-type="',con.type,'" >') as application_id,
