...
from cc_card d 
inner join cc_contract t on t.code = ${fld:contractcode} and t.org_id = d.org_id 
...
where d.code = ${fld:cardcode} and d.org_id = ${def:org} 
--zzn 连续续卡
--and d.isgoon = 0 
...
and e.maxusernum = 1
--zzn 增加合同编号的条件
and d.contractcode=${fld:contractcode}
