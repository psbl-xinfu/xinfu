(function ($) {
    ...
    $.fn.freezeHeader = function (params) {
        ...
        function cloneHeaderRow(obj) {
            obj.container.html('');
            obj.container.val('');
            var tabela = $('<table style="margin: 0 0;background:#f5f5f5;"></table>');
...
var height = $(".panel-body").height();//获取父级DIV高度
$(".table").freezeHeader({ 'height': '300px' });//设置table高度 控制滚动条
