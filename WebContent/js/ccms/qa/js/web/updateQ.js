(function() {
	...
	$Q_init = $Q.fn.init = function() {
		...
		this.ckfocus = function() {
		 ...
		 this.submitForm = function(){
				...
				var url = $("#actionroot").val() + "/update_question/update";
				ajaxCall(url,{
					method: "post",
					progress: true,
					form: "qaForm",
					...
					success: function() {
						...
						alert("保存成功");
						gotoPage("/action/ccms/qa/web/q_and_a?qid="+$('#tuid').val()+"&random="+Math.random());
	...
	window["ccms"]["update_question"] = $Q;
})();

$(document).ready(function() {
	ccms.update_question();
});
