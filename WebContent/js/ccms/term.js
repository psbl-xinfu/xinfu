...
function Term(id,name,contentDiv){
	...
	this.printHTML = function(callback){//全部输出出来
		...
		str += '<button type="button" id="save_btn" class="btn btn-primary btn-md" style="display:none">保&nbsp;存</button>';
		str += '</div>';
...
function TermTypes(id,name,code){
	...
	this.toHTML = function(){
		...
		str += '<img src="' + contextPath + '/js/ccms/img/ShiTiType1.png" class="shiTiType" code="' + code + '"/>';
		str += '<span>' + name + '</span>';
		str += '</div>';
...
function TermItem(id,name,code,is_matrix,show_type,is_page_break,show_order,remark,is_matrix_transpose,is_list_mline,type_id){
	...
	this.toHTML = function(){
		...
		str += '<div class="titleNum"><a  name="a'+this.type_id + '' + this.show_order +'">'+this.show_order+'</a></div>';
		str += '<div class="panel-heading"><span>'+this.name+(this.remark!=""?("&nbsp;&nbsp;&nbsp;【备注】"+this.remark):"")+'</span></div>';
...
function TermList(id,item_id,list_name,list_code,list_score,show_order,show_type,is_unspeak,remark,parent_type,item_code,namespace_op){
	...
	this.toSelectionHTML = function(){//非矩阵题目时的选择项输出成HTML格式
		...
		switch(this.parent_type){
			case "0"://文本输入
				str += "<input type='text' code='selection' name='"+this.item_code+"' size='20' id='"+this.item_code+"_"+this.list_code+"' placeholder='请输入文本'>";
				break;
			case "1"://多选一
				switch(this.show_type){
					case "0"://标签
						...
						break;
					case "1"://文本
						str += "<input type='text' onclick='showExtLabel(\""+this.item_code+"_\",this);' code='selection' name='"+this.item_code+"_text' size='20' id='"+this.item_code+"_"+this.list_code+"_text'>";
						break;
					case "2"://标签+文本
						str += "<input type='radio' onclick='showExtLabel(\""+this.item_code+"_\",this);' code='selection' name='"+this.item_code+"' value='"+this.list_score+"' id='"+this.item_code+"_"+this.list_code+"'>"
						+"<label for='"+this.item_code+"_"+this.list_code+"'>"+this.list_code+"</label>"
						+"&nbsp;&nbsp;<span name='"+this.item_code+"_span' id='"+this.item_code+"_"+this.list_code+"_span' style='display:none'><input type='text' name='"+this.item_code+"_text' size='20' id='"+this.item_code+"_"+this.list_code+"_text'> </span>";
						break;
					case "3"://标签+下拉框
						str += "<input type='radio' onclick='showExtLabel(\""+this.item_code+"_\",this);' code='selection' name='"+this.item_code+"' value='"+this.list_score+"' id='"+this.item_code+"_"+this.list_code+"'>"
						+"<label for='"+this.item_code+"_"+this.list_code+"'>"+this.list_code+"</label>";
			...
			case "2"://复选
				switch(this.show_type){
					case "0"://标签
						...
						break;
					case "1"://文本
						str += "<input type='text' onclick='showExtLabel(\""+this.item_code+"_\",this);' code='selection' name='"+this.item_code+"_text' size='20' id='"+this.item_code+"_"+this.list_code+"_text' placeholder='请输入文本'>";
						break;
					case "2"://标签+文本
						str += "<input type='checkbox'  onclick='showExtLabel(\""+this.item_code+"_\",this);' code='selection' name='"+this.item_code+"' value='"+this.list_score+"' id='"+this.item_code+"_"+this.list_code+"'>"
						+"<label for='"+this.item_code+"_"+this.list_code+"'>"+this.list_code+"</label>"
