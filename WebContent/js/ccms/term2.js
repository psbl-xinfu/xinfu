		...
		switch(this.parent_type){
			...
			case "1"://多选一
				switch(this.show_type){
					case "0"://标签
						str += "<input type='radio' code='selection' name='"+this.item_code+"' value='"+this.list_score+"' id='"+this.item_code+"_"+this.list_code+"'>"
						+"<label for='"+this.item_code+"_"+this.list_code+"'>"+this.list_code+"</label>";
						break;
					case "1"://文本
						str += "<input type='text' code='selection' name='"+this.item_code+"_text' size='20' id='"+this.item_code+"_"+this.list_code+"_text'>";
						break;
					case "2"://标签+文本
						str += "<input type='radio' code='selection' name='"+this.item_code+"' value='"+this.list_score+"' id='"+this.item_code+"_"+this.list_code+"'>"
						+"<label for='"+this.item_code+"_"+this.list_code+"'>"+this.list_code+"</label>"
			...
			case "2"://复选
				switch(this.show_type){
					case "0"://标签
						str += "<input type='checkbox' code='selection' name='"+this.item_code+"' value='"+this.list_score+"' id='"+this.item_code+"_"+this.list_code+"'>"
						+"<label for='"+this.item_code+"_"+this.list_code+"'>"+this.list_code+"</label>";
						break;
					case "1"://文本
						str += "<input type='text' code='selection' name='"+this.item_code+"_text' size='20' id='"+this.item_code+"_"+this.list_code+"_text' placeholder='请输入文本'>";
						break;
					case "2"://标签+文本
						str += "<input type='checkbox' code='selection' name='"+this.item_code+"' value='"+this.list_score+"' id='"+this.item_code+"_"+this.list_code+"'>"
						+"<label for='"+this.item_code+"_"+this.list_code+"'>"+this.list_code+"</label>"
