...
//15分钟一个档
  cM[Math.floor(this.minute/15)].selected = true;
  cs[Math.floor(this.second/60)].selected = true;
  this.minute = cM[Math.floor(this.minute/15)].value;
  this.second = cs[Math.floor(this.second/60)].value;
