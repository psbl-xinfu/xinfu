...
left join hr_staff_skill  ON hr_staff_skill.skill_id = skill.skill_id 
left join hr_staff on hr_staff.userlogin=hr_staff_skill.userlogin and hr_staff.org_id=${def:org} 
where tg.org_id=${def:org} and tg.tuid = ${fld:tuid}
and hr_staff.userlogin='${def:user}'
--and hr_staff.userlogin='xijinping'
