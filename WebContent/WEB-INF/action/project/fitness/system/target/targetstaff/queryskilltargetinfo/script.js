...
var html = "";
html+="${fld:yearmonth}&nbsp;&nbsp;${fld:val}：共计${fld:staffnum}人<div><nav>";
...
if(skill_scope=="0"){
	...
	html+="<li  style='width:220px;margin-left:-68%'><p ><span >场开量：${fld:site_target}</span><span  id='site_target${fld:tuid}'></span></p></li>";
...
if(count==0){
	...
	$("#test_target${fld:tuid}").html("<i>环比+0%");
