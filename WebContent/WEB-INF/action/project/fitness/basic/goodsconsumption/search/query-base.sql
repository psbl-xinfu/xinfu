select 
	...
	ls.factmoney,
	ls.created,
	(select name from hr_staff where userlogin = ls.createdby ) as staff_name,  --zzn20190327 其他店的管理员也可能进店销售
...
left join cc_card card on ls.paycardcode = card.code and card.isgoon = 0 and card.org_id=ls.org_id  --zzn20190327
