select
	...
	(select (case when lefttime is null then (select cabinettempcode from cc_cabinettemp where tuid::varchar = cc_inleft.cabinettempcode and org_id = ${def:org}) else '' end)
