...
<rows>
	...
	cardrestlist+="<tr>"
		...
		+"<td id='shixiaotd"+cardcount+"' style='display: none;'><select id='shixiao"+cardcount+"' name='shixiao' style='background: #282e34 !important;border: none!important;outline: none!important;color: #969da4 !important;box-shadow: none!important;width:60%'>"
		+"<shixiao-rows>"
		+"<option value='${fld:shixiaocardtypecode}'>${fld:shixiaocardtypename}</option>"
		+"</shixiao-rows></td>"
		+"<td id='jicitd"+cardcount+"' style='display: none;'><select id='jici"+cardcount+"' name='jici' style='background: #282e34 !important;border: none!important;outline: none!important;color: #969da4 !important;box-shadow: none!important;width:60%'>"
		+"<jici-rows>"
