...
(select 
	...
	(select count(1) from cc_guest guest
		...
		and (case when ${fld:end_date} is null then 1=1 else guest.created::date<=${fld:end_date} end)
	 	and (case when ${fld:skill_name} is null then 1=1 else guest.mc=${fld:skill_name} end)
	) as guestnum,
	(select count(1) from cc_customer cust
		...
		and (case when ${fld:end_date} is null then 1=1 else cust.created::date<=${fld:end_date} end)
	 	and (case when ${fld:skill_name} is null then 1=1 else cust.mc=${fld:skill_name} end)
	) as custnum
FROM hr_staff s 
...
and (case when ${fld:skill_name} is null then 1=1 else s.userlogin=${fld:skill_name} end) 
...
FULL JOIN(
	...
	and (case when ${fld:end_date} is null then 1=1 else ts.created::date<=${fld:end_date} end)
 	and (case when ${fld:skill_name} is null then 1=1 else ts.userlogin=${fld:skill_name} end)
	and exists(
...
FULL JOIN(
	...
	and (case when ${fld:end_date} is null then 1=1 else g.created::date<=${fld:end_date} end)
 	and (case when ${fld:skill_name} is null then 1=1 else g.initmc=${fld:skill_name} end)
	and exists(
		select 1 from hr_skill k 
		inner join hr_staff_skill fk on k.skill_id = fk.skill_id 
...
FULL JOIN(
	...
	and (case when ${fld:end_date} is null then 1=1 else c.created::date<=${fld:end_date} end)
 	and (case when ${fld:skill_name} is null then 1=1 else c.createdby=${fld:skill_name} end)
	and exists(
		select 1 from hr_skill k 
		inner join hr_staff_skill fk on k.skill_id = fk.skill_id 
...
FULL JOIN(
	...
	and (case when ${fld:end_date} is null then 1=1 else gp.created::date<=${fld:end_date} end)
 	and (case when ${fld:skill_name} is null then 1=1 else gp.createdby=${fld:skill_name} end)
	and exists(
		select 1 from hr_skill k 
		inner join hr_staff_skill fk on k.skill_id = fk.skill_id 
...
FULL JOIN(
	...
	and (case when ${fld:end_date} is null then 1=1 else gv.created::date<=${fld:end_date} end)
 	and (case when ${fld:skill_name} is null then 1=1 else gv.mc=${fld:skill_name} end)
	and exists(
		select 1 from hr_skill k 
		inner join hr_staff_skill fk on k.skill_id = fk.skill_id 
