SELECT
	...
	(t.pttotalcount::double precision*t.ptfactfee::double precision)::numeric(10,2) AS totalfee,-- 金额
	t.ptmoney,
...
INNER JOIN hr_staff fp ON t.createdby = fp.userlogin /**AND fp.i_status = 1*/ and t.org_id = fp.org_id
