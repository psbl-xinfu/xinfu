...
SELECT 
   ...
   ,(
	...
	,(select name from cc_cardtype where code = get_arr_value(t.relatedetail, 2) and org_id = ${def:org}) as vc_oldcardtype
	,(select name from cc_cardtype where code = get_arr_value(t.relatedetail, 3) and org_id = ${def:org}) as vc_cardtype
