...
SELECT 
   ...
   ,(
	...
	,t.normalmoney::numeric(10,2) AS c_normalmoney
	,(t.inimoney - t.normalmoney)::numeric(10,2) AS f_discount
	,t.factmoney::numeric(10,2) as f_factmoney
	,(t.normalmoney - t.factmoney)::numeric(10,2) AS c_leftmoney
	...
	,df.ptfee  as pt_fed --私教课单价
	,df.ptlevelname as vc_classname
	,rt.ptenddate as c_ptenddate
	,'' AS c_enddate 
...
INNER join cc_ptdef df on df.code=rt.ptlevelcode and df.org_id = rt.org_id
