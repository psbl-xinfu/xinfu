	...
	public void print(GenericTransaction data) throws Throwable
	{
        ...
        if ("export".equals(action)) {
        	...
        	try{
                ...
                getResponse().getWriter().write("<script language=\"javascript\">parent.reportObj.jorSearchOK();</script>");
        	}catch(Throwable a){
        		getResponse().getWriter().write("<html><head></head><body><script language=\"javascript\">parent.reportObj.jorSearchError('"+encodeJS(a.getMessage())+"');</script></body></html>");
