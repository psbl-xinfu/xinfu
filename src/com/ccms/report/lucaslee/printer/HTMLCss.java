...
public class HTMLCss {
	...
	public String getTableNormal() {
		return tableNormal;
	}

	public void setTableNormal(String tableNormal) {
	...
	public String toString() {
		...
		buf.append(".").append(Report.GROUP_PERCENT_TYPE).append("{").append(
				this.groupTotal).append("}\r\n");
		buf.append(".").append(Report.TOTAL_TYPE).append("{")
		.append(this.total).append("}\r\n");
		buf.append(".").append(Report.TOTAL_PERCENT_TYPE).append("{")
		.append(this.total).append("}\r\n");
