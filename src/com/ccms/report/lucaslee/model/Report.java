...
public class Report {
	...
	/** **********************单元序列对象的类型,用于样式表************************** */
	/** 基本表格 */
	public static final String TABLE_NORMAL = "MyReport";
	...
	/** 分组百分比 */
	public static final String GROUP_PERCENT_TYPE = "MyReport_groupPercent";

	/** 汇总 */
	public static final String TOTAL_TYPE = "MyReport_total";

	/** 百分比 */
	public static final String TOTAL_PERCENT_TYPE = "MyReport_totalPercent";
