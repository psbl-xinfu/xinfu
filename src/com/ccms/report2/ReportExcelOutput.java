...
import com.ccms.report2.lucaslee.report.printer.ExcelCss;
import com.ccms.report2.lucaslee.report.printer.ExcelPrinter;
...
{	
	...
	public WritableWorkbook createWorkbook(GenericTransaction data, ByteArrayOutputStream buf) throws Throwable
	{
        ...
        if(strReportType.equals("2")){  /*交叉报表*/
			getExcelReport(getCrossReport(data), buf, rsReportCss);
        }else if(strReportType.equals("1")){
            getExcelReport(getGroupReport(data), buf, rsReportCss);
        }else if(strReportType.equals("0")){
            getExcelReport(getFlatReport(data), buf, rsReportCss);
        }
	 ...
	 * @throws Exception
	 */
	public void getExcelReport(Report report, OutputStream os, final Recordset reportCss)
			throws Throwable {
