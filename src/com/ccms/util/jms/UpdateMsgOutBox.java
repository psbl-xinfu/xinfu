...
public class UpdateMsgOutBox extends GenericTableManager {
	...
	public int service(Recordset inputParams) throws Throwable {
		...
		Db db = getDb();
		String update = getSQL(getResource("update-outbox.sql"),inputParams);
		String delete_outbox_staff = getSQL(getResource("delete-outbox_staff.sql"),inputParams);
