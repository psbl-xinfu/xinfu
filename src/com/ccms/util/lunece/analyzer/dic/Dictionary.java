 ...
 * 
 */
package com.ccms.util.lunece.analyzer.dic;
...
public class Dictionary {
	...
	private void loadMainDict(){
		...
		//读取主词典文件
        InputStream is = this.getClass().getClassLoader().getResourceAsStream(Configuration.PATH_DIC_MAIN);
        if(is == null){
	...
	private void loadStopWordDict(){
		...
		if(extStopWordDictFiles != null){
			...
			for(String extStopWordDictName : extStopWordDictFiles){
				...
				//读取扩展词典文件
				System.out.println("extStopWordDictName="+extStopWordDictName);
	...
	private void loadQuantifierDict(){
		...
		//读取量词词典文件
        InputStream is = this.getClass().getClassLoader().getResourceAsStream(Configuration.PATH_DIC_QUANTIFIER);
        if(is == null){
