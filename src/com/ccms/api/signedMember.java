 ...
 * 
 */
public class signedMember extends GenericTransaction {
	public int service(Recordset inputParams) throws Throwable {
		...
		Recordset rsGetuserMember = new Recordset();
		...
		try {
			...
			rsGetuserMember.append("errcode", Types.VARCHAR);
			rsGetuserMember.append("errmsg", Types.VARCHAR);
			rsGetuserMember.addNew();
			rsGetuserMember.setValue("errcode", String.valueOf(tuid));
			rsGetuserMember.setValue("errmsg", qrcodePath);
			publish("_rsGetuserMember", rsGetuserMember);
		}
		return rc;
	}
