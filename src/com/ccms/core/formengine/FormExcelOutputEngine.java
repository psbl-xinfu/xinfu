...
public class FormExcelOutputEngine extends AbstractExcelOutput {

	public WritableWorkbook createWorkbook(GenericTransaction data, ByteArrayOutputStream buf) throws Throwable {

		String form_id = getRequest().getParameter("form_id");
		...
		if(querySql != null && querySql.length() > 0){
			...
			try
			{
				...
				Integer formId = Integer.parseInt(form_id);
				FormBean form = cp.getFormBeanById(formId);
	...
	public static void main(String[] args) {
		System.out.println(java.net.URLEncoder.encode("http://hairs.desoft.cn/ccms/action/project/hairs/weixin/location?flag=2"));
	}
