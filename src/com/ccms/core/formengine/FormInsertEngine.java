...
public class FormInsertEngine extends GenericTableManager implements IServiceWrapper {
	...
	public int service(Recordset inputs) throws Throwable {
		...
		if(is_user_replace_class == false){
			...
			//将新增之后的主键信息，table_id
			inputParams.setValue("bpk_field_value", bpk_field_value);
			inputParams.setValue("table_id", form.getTable_id());
