...
public class VipReserveValidate extends GenericTransaction
{
	...
	public synchronized int service(Recordset inputParams) throws Throwable
	{
		...
		if(errors.getErrors().getRecordCount() > 0){
			getRequest().setAttribute("dinamica.error.validation", "/action/project/weixin/club/campaign/shift/alert_price");
