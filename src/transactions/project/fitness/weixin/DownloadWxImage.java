...
public class DownloadWxImage extends GenericTableManager {
	...
	public int service(Recordset inputParams) throws Throwable {
		...
		try {
			...
			String update = getLocalResource("/transactions/project/weixin/common/update-img.sql");
			for( int i = 0; i < idLen; i++ ){
				...
				_update = StringUtils.replace(_update, "${file_path}", "/upload/staff/"+org_id+"/" + filename);
